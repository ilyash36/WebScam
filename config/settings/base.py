"""
Базовые настройки Django для проекта автосервиса.
"""
import os
...
# Yandex Vision OCR (для распознавания СТС на странице записи)
...
# --- Email (SMTP при EMAIL_BACKEND=smtp) ---
# Публичный URL сайта для ссылок в письмах (обязательно за reverse-proxy / Docker)
SITE_URL = os.getenv('SITE_URL', '').strip().rstrip('/')
DEFAULT_FROM_EMAIL = os.getenv(
    'DEFAULT_FROM_EMAIL',
    'noreply@chernyavskiy-atech.ru',
)
