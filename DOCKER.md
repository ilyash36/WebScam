...
> **Канонический порядок чтения** — [AI_CONTEXT.md](./AI_CONTEXT.md) §1. Этот файл (**DOCKER**) — шаг **6** (после SETUP; по задаче).
...
- `YANDEX_VISION_API_KEY`, `YANDEX_FOLDER_ID` - для OCR СТС (Vision API)
